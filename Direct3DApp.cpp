...
private:
	...
	ComPtr<ID3D12DescriptorHeap> mSrvDescriptorHeaps = nullptr;
...
void Direct3DApp::OnKeyboardInput(const GameTimer& gt)
{
...
void Direct3DApp::UpdateCamera(const GameTimer& gt)
{
...
void Direct3DApp::UpdateObjectCBs(const GameTimer& gt)
{
...
void Direct3DApp::UpdateMainPassCB(const GameTimer& gt)
{
...
void Direct3DApp::BuildDescriptorHeaps()
{
...
void Direct3DApp::BuildConstantBufferViews()
{
...
void Direct3DApp::BuildShadersAndInputLayout()
{
...
void Direct3DApp::BuildShapeGermetry()
{
...
void Direct3DApp::BuildFrameResources()
{
...
void Direct3DApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
	UINT objCBByteSize = d3dUtil::CalcConstantBufferByteSize(sizeof(ObjectConstants));
